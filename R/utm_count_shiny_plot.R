#' utm_count_shiny_plot() : For one interactive plot at-a-time using plotly, for shiny dashboard
#'
#' This function creates of one interactive plot at a time using Plotly for count metric. It takes a data frame from
#' df_count_metric_values.rda, processes it to generate an interactive plot, and returns the plot for shiny dashboard.
#'
...
utm_count_shiny_plot <- function(.data) {
  ...
  new_plot <- utVizR::utm_count_interactive_plot(.data =step_3, list_name =step_3$list_name)
