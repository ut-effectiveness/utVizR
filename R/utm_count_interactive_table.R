#' utm_count_interactive_table() : Modify data frame in order to make it compatible for 'utm_count_shiny_table()
#' function.'
#'
...
utm_count_interactive_table <- function(.data, list_name) {
